                ...
                for(var i = 0; i < lists.length; i++) {
                    ...
                    var html = '<div class="am-u-sm-12 am-u-md-6 am-u-lg-3 admin-detail-item">' + 
                                    '<div class="am-cf admin-detail-list">' +
                                        '<img class="admin-detail-img" src="'+ lists[i].qrcode +'" alt="">' +
                                        '<div class="admin-detail-content">' +
                                            '<div class="admin-detail-content-left">' +
                                                '<span class="admin-detail-content-device-name">#' + lists[i].gid + '</span>' + 
                                                '<span class="admin-detail-content-user-name">' + lists[i].currentUser + '人使用</span>' +
                                            '</div>' +
